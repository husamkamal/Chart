...
const initialMain={month:"",reservations:[{number:66,name:"الحجوزات",month:'November'},{number:32,name:" الحجوزات قيد التنفيذ",month:'November'},{number:34,name:" الحجوزات السابقة",month:'November'},{number:'2000 ريال',name:" المدفوعات",month:'November'}],chartDataPoint : [
